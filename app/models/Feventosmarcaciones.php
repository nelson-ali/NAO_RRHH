...
*   Fecha Creaci�n:  06-06-2016
*/
use Phalcon\Mvc\Model\Resultset\Simple as Resultset;

class Feventosmarcaciones extends \Phalcon\Mvc\Model
{
    public $total_rows;
    ...
    /**
     * Funci�n para obtener el listado de los registros de eventos m�viles con relaci�n a la asignaci�n de marcaciones.
     * @param int $idEventoMovil
     * @param int $idEventoMarcacion
     * @param int $ws
     * @param string $where
     * @param string $group
     * @param int $offset
     ...
     * @return Resultset
     */
    public function getAll($idEventoMovil = 0, $idEventoMarcacion = 0, $ws = 1, $where = '', $group = '', $offset = 0, $limit = 0)
    {
        $sql = "SELECT * FROM f_eventosmoviles_marcaciones($idEventoMovil, $idEventoMarcacion,$ws,'$where','$group',$offset,$limit)";
        //echo "<p>------->".$sql;
