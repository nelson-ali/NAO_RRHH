...
$objPHPExcel->getActiveSheet()->getStyle($celdaFinal)->applyFromArray(
		array(
			'borders' => array(
				'right'     => array(
 					'style' => PHPExcel_Style_Border::BORDER_THIN
...
$objPHPExcel->getActiveSheet()->getHeaderFooter()->setOddHeader('&L&BReporte Relación laboral&RImpreso en &D');
