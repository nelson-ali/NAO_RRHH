    ...
    return {
        init: function () {
            $("#form-validation").validate({
                ...
                rules: {
                    val_username: {required: !0, minlength: 3},
                    val_email: {required: !0, email: !0},
                    val_password: {required: !0, minlength: 5},
                    val_confirm_password: {required: !0, equalTo: "#val_password"},
                    val_bio: {required: !0, minlength: 5},
                    val_skill: {required: !0},
                    val_website: {required: !0, url: !0},
                    val_credit_card: {required: !0, creditcard: !0},
                    val_digits: {required: !0, digits: !0},
